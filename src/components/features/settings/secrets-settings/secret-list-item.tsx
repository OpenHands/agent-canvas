...
export function SecretListItemSkeleton() {
  return (
    <div className="skeleton-stagger border-t border-[var(--oh-border-input)] last-of-type:border-b w-full min-w-0 pr-2.5 py-[13px] flex items-center justify-between">
