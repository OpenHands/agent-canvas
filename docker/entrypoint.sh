...
export AUTOMATION_POSTHOG_API_KEY="${AUTOMATION_POSTHOG_API_KEY:-${VITE_POSTHOG_API_KEY:-}}"
export AUTOMATION_POSTHOG_HOST="${AUTOMATION_POSTHOG_HOST:-${VITE_POSTHOG_HOST:-}}"
