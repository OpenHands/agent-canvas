...
describe("AnalyticsConsentFormModal", () => {
  ...
  it("calls setTelemetryConsent('granted') when user submits with analytics checked", async () => {
  ...
  it("calls setTelemetryConsent('denied') when user unchecks and submits", async () => {
    render(<AnalyticsConsentFormModal onClose={onCloseMock} />);
