...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'AUTOMATIONS$WORKFLOWS_TITLE',
  'AUTOMATIONS$WORKFLOWS_SUBTITLE',
  'AUTOMATIONS$ROUTINES_TITLE',
  'AUTOMATIONS$ROUTINES_SUBTITLE',
  'AUTOMATIONS$RESPONDERS_TITLE',
  'AUTOMATIONS$RESPONDERS_SUBTITLE',
  'AUTOMATIONS$DASHBOARD_TITLE',
  'AUTOMATIONS$DASHBOARD_SUBTITLE',
  'AUTOMATIONS$TEMPLATES_TITLE',
  'AUTOMATIONS$TEMPLATES_SUBTITLE',
  'AUTOMATIONS$DASHBOARD_STATS_TOTAL',
  'AUTOMATIONS$DASHBOARD_STATS_ACTIVE',
  'AUTOMATIONS$DASHBOARD_STATS_ROUTINES',
  'AUTOMATIONS$DASHBOARD_STATS_RESPONDERS',
  'AUTOMATIONS$DASHBOARD_RECENT_ACTIVITY',
  'AUTOMATIONS$DASHBOARD_NO_ACTIVITY',
  'AUTOMATIONS$DASHBOARD_RECENT_RUN_AGO',
  'AUTOMATIONS$DASHBOARD_CTA_CREATE_TITLE',
  'AUTOMATIONS$DASHBOARD_CTA_CREATE_DESC',
  'AUTOMATIONS$DASHBOARD_CTA_TEMPLATES_TITLE',
  'AUTOMATIONS$DASHBOARD_CTA_TEMPLATES_DESC',
  'BACKEND$CLOUD_TITLE',
