...
const IDENTICAL_VALUE_ALLOWLIST = new Set([
  ...
  'APP_MODE$CODE',
  'APP_MODE$WORK',
  'APP_MODE$TOGGLE_ARIA',
  'APP_MODE$WORK_CLOUD_TOOLTIP',
  'APP_MODE$WORK_CLOUD_FALLBACK',
  'WORK$HOME_TITLE',
  'WORK$HOME_DESCRIPTION',
  'WORK$SCAFFOLD_NOTICE',
  'WORK$SETUP_TITLE',
  'WORK$SETUP_BODY',
  'WORK$SETUP_ADD_FOLDERS',
  'WORK$SETUP_SAVE',
  'WORK$RUNTIME_UNAVAILABLE',
  'WORK$CREATING_TASK',
  'WORK$CREATE_FAILED',
  'WORK$RECENT_TASKS',
  'WORK$CLOUD_UNAVAILABLE_TITLE',
  'WORK$CLOUD_UNAVAILABLE_BODY',
  'WORK$CLOUD_SWITCH_LOCAL',
  'WORK$CLOUD_BACK_TO_CODE',
  'SETTINGS$NAV_WORK',
  'SETTINGS$PAGE_WORK_SUBLINE',
  'WORK$SETTINGS_RUNTIME_TITLE',
  'WORK$SETTINGS_RUNTIME_OK',
  'WORK$SETTINGS_RUNTIME_UNAVAILABLE',
  'WORK$SETTINGS_WORKSPACE_TITLE',
  'WORK$SETTINGS_WORKSPACE_NAME',
  'WORK$SETTINGS_WORKSPACE_NAME_PLACEHOLDER',
  'WORK$SETTINGS_FOLDERS_HELP',
  'WORK$SETTINGS_DELIVERABLES_LABEL',
  'WORK$SETTINGS_DELIVERABLES_HELP',
  'WORK$SETTINGS_SAVE',
  'WORK$TOOLS_SETUP_TITLE',
  'WORK$TOOLS_SETUP_BODY',
  'WORK$TOOLS_CONVERSATION_TITLE',
  'WORK$TOOLS_CONVERSATION_DISMISS',
  'WORK$TOOLS_CONVERSATION_BODY',
  'WORK$TOOLS_NONE_AVAILABLE',
  'WORK$TOOL_BROWSER_LABEL',
  'WORK$TOOL_BROWSER_DESCRIPTION',
  'WORK$TOOL_REQUEST_PROMPT',
  'WORK$TOOL_REQUEST_WITH_REASON',
  'WORK$TOOL_REQUEST_APPROVED_MESSAGE',
  'WORK$TOOL_REQUEST_APPROVED_TAGS_ONLY_MESSAGE',
  'WORK$TOOL_REQUEST_DECLINED_MESSAGE',
  'WORK$TOOL_GRANT_FAILED',
  'WORK$TOOL_REQUIRES_NEW_TASK',
  'WORK$TOOL_RECREATED_MESSAGE',
]);
